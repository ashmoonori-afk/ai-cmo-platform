...
모든 산출물은 `prompts/shared/deliverable-standard.md`의 **공통 형식 5개**를 따른다:
① 첫머리 "한 장 요약"(전문용어 없이: 이게 뭔지/어디에 쓰는지/오늘 할 일 하나)
② 경로·파일명 규칙 ③ 한국어 기본 ④ 정직성 태그([추정]/[미확인]/"모름")
⑤ 문서 끝 "다음 단계" 2~3개. 운영형 산출물(콘텐츠·SNS·플레이스·광고·리뷰)은
같은 문서의 10대 기준을 추가 적용한다. reviewer가 gate-check 1단계에서 검사한다.
