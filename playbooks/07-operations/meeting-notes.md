...
- `clients/{client}/config.md` — 브랜드 컨텍스트, 팀 구성
- `knowledge-base/{client}/insights.md` — 이전 미팅 결정 사항 (연속성 확인)
...
```
outputs/{client}/operations/meeting-notes-{YYYY-MM-DD}-{meeting-type}.md
```
