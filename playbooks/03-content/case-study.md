...
B2C 브랜드의 경우 전통적 케이스스터디 대신 "고객 스토리" 형식을 사용한다:

**B2C 고객 스토리 구조:**
1. **고객 소개** (100자): 연령, 직업, 가족 구성 등 페르소나 설명
2. **구매 전 고민** (200자): 어떤 상황에서 제품을 찾게 되었는가
3. **선택 이유** (200자): 왜 이 브랜드/제품을 선택했는가 (경쟁 대비)
4. **사용 경험** (300자): 실제 사용 후 느낀 점, 구체적 에피소드
5. **추천 한마디** (100자): 다른 고객에게 하고 싶은 말

**데이터 소스:** 자사몰 리뷰, SNS 후기, 맘카페 언급 등에서 수집 (인터뷰 불요)
**publish_permission = anonymize**: 닉네임 또는 "30대 워킹맘 A씨" 형식

config.md의 B2B/B2C 비중에서 B2C > 50%이면 고객 스토리 형식을 기본으로 사용한다.
