...
- `clients/{brand}/config.md` — ICP, 경쟁사 정보
- `knowledge-base/{brand}/insights.md` — 기존 SEO 인사이트
...
```
outputs/{brand}/seo/keyword-research-{YYYYMMDD}.md
```
