...
```
필수 포함 요소:
1. 제안 제목 (3개 옵션) — 데이터 기반 공식 적용:
   40-60자 / 질문형 CTR +14.1% / 괄호 포함 +~40% [2차] / 숫자 포함 우위
   (근거: Backlinko 400만 검색결과, HubSpot — docs/research/2026-07-02-seo-geo-research.md)
2. 메타 설명 초안
3. H1 (페이지 헤딩)
4. H2 목차 구조 (섹션별 설명)
...
9. 목표 분량
10. CTA 설계
11. 인용 유도 블록 (GEO — prompts/shared/geo-checklist.md):
    - 출처 있는 통계 문장 2개 이상 (+31%)
    - 전문가/공식 인용문 1개 이상 (+41%)
    - "X란 Y이다" 정의문 1개 이상
    - 첫 H2 이전 40-60단어 직답 문단
    ※ AI 표면(AI 브리핑/AIO)이 뜨는 키워드면 목표를 "클릭"에서
      "AI 답변 내 브랜드 인용 노출"로 전환 가능 — 개요에 명시
```
