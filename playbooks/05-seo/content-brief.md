...
BRAND_VOICE: {voice}        # 브랜드 톤앤매너 (clients/{brand}/brand-guidelines.md 참조)
```

## 참조 문서

- `clients/{brand}/brand-guidelines.md` — 브랜드 보이스, 금지어
- `clients/{brand}/config.md` — ICP, 타겟 페르소나
- `knowledge-base/{brand}/winning-copy.md` — 성과 낸 카피 패턴
...
```
outputs/{brand}/seo/content-brief-{slug}-{YYYYMMDD}.md
```
