...
- **68개 플레이북(SOP)**: 검증된 마케팅 프레임워크 내장 (코어 43 + 체인 5 + 역할 SOP 10 + 로컬 실행 7 + 유료 광고 3)
...
> 아래는 자주 쓰는 핵심 플레이북입니다. 전체 68개(디자인 5, 체인 5, 역할 SOP 10, 로컬 실행 7, 유료 광고 3 포함)는 `playbooks/` 폴더에서 확인할 수 있습니다.
