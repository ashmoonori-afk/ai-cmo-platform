...
> 11개 AI 에이전트 + 64개 플레이북으로 마케팅 반복 업무를 표준화하는 노코드 AI 마케팅 운영체계
...
- **64개 플레이북(SOP)**: 검증된 마케팅 프레임워크 내장 (코어 42 + 체인 5 + 역할 SOP 10 + 로컬 실행 7)
...
> 아래는 자주 쓰는 핵심 플레이북입니다. 전체 64개(디자인 5, 체인 5, 역할 SOP 10, 로컬 실행 7 포함)는 `playbooks/` 폴더에서 확인할 수 있습니다.
