...
- 자연어 요청을 43개 workflow mapping으로 분류합니다.
- 10개 specialist role과 33개 core playbook으로 실행합니다.
- 역할별 SOP, Reviewer gate, Reporter KB 기록으로 품질을 고정합니다.
- Neurosis, Odyssey, Morpheus, codex-image-gen 패턴을 승인 기반 handoff로
  배치합니다.
...
| Birkin contracts | `integrations/birkin/` | Approval-gated handoff contracts |
