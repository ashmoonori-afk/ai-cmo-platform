...
| Store app | `python -m aicmo.store_app` + `work` | 로그인·3단계 가게 입력/임시 저장·가게 권한·지속 작업·문안 확인·검증된 ZIP 저장. 운영자 설정 필요. [실행 방법](docs/STORE_APP.md) |
...
로컬 전용 제품 로드맵과 결정 기록에서 검토하며, G02는 OPEN 상태입니다. 사용자의 자연어
