...
| Strategy, content, sales, and reporting are disconnected. | Chain playbooks route work from request to delivery. | `playbooks/00-chains/` |
| AI outputs are hard to trust. | Reviewer gates enforce structure, evidence, brand, and risk checks. | `prompts/shared/gate-check.md`, `agents/reviewer.md` |
| Learning disappears after delivery. | Reporter records durable knowledge and follow-up tasks. | `prompts/shared/knowledge-update.md` |

## What It Is

- a Markdown-based AI CMO operating system
- 10 specialist roles
