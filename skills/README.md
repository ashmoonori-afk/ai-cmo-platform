...
This folder contains self-contained skill protocols used by AI CMO Platform.
They are included so users can run the platform from this repository alone,
without a separate Birkin installation.

## Included Skill Set

| Skill | Path | AI CMO Placement |
|-------|------|------------------|
| Neurosis | `birkin/neurosis/SKILL.md` | Clarify vague or risky requests before execution. |
