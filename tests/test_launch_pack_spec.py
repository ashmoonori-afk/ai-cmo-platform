...
_DELIVERY_PRODUCERS = {
    "local-pack-feedback": ("candidate", "owner_gate"),
    "weekly-report": ("report",),
    "local-store-pack": ("drafts", "photos", "owner_gate"),
...
_HANDOFF_INPUTS = {
    "local-pack-feedback": (),
    "weekly-report": ("load_context",),
    "local-store-pack": ("load_context", "learning_context", "photos"),
